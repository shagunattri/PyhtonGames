...
print('Hello, ' + fname.capitalize() + ' ' +  lname.capitalize() +  " Let's get started!!")
...
out2 = 'My Fav Console is {} {}'.format(unoname.capitalize(),dosname.capitalize())
print(out2)

out3 = 'My Fav Console is {1} {0}'.format(unoname.capitalize(),dosname.capitalize())
print(out3)
...
# using datetime and timedelta for knowing day before yesterday 
